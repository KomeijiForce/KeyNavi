...
for data in load_dataset("ChilleD/SVAMP")["train"]:
    dataset.append({"question": data["question_concat"], "answer": data["Answer"]})

for data in load_dataset("ChilleD/SVAMP")["test"]:
    dataset.append({"question": data["question_concat"], "answer": data["Answer"]})
